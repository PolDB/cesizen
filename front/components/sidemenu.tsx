...
const styles = StyleSheet.create({
  ...
  btnConnexion: { marginHorizontal: 24, marginTop: 8, backgroundColor: COLORS.violet, padding: 13, borderRadius: 12, alignItems: 'center',alignSelf: 'stretch', },
  btnConnexionTexte: { color: COLORS.blanc, fontWeight: '600', fontSize: 14 },
  btnInscription: { marginHorizontal: 24, marginTop: 8, borderWidth: 1.5, borderColor: COLORS.violet, padding: 12, borderRadius: 12, alignItems: 'center',alignSelf: 'stretch', },
